...
**На мой взгляд архитектура будет меняться - сначала изменяемая, так как конфигурация будет дрейфовать**\
**из-за большого количества небольших релизов тестирований интеграций, откатов, доработок возможны расхождения между тестовым контуром и продом.**\
...
**Но возможна замена terraform на pulumi.**
